...
>(({ className, children, setDialogOpen, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay onClick={() => setDialogOpen && setDialogOpen(false)} />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'mb-1 text-xl font-semibold leading-none tracking-tight',
      className,
    )}
    {...props}
  />
